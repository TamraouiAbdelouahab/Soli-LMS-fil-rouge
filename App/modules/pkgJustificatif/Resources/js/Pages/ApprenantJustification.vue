<template>
    ...
    <AuthenticatedLayout>
        <div class="min-h-screen bg-gray-50 p-4 md:p-6">
            <div class="flex flex-col md:flex-row items-center justify-between">
                ...
                <div class="flex gap-2">
                    <div class="flex justify-end">
                        <button type="button" @click="filterVisible = !filterVisible" :class="((filterVisible) ? 'bg-blue-600 hover:bg-gray-100 text-white hover:text-gray-900':'bg-white hover:bg-blue-800 text-gray-900 hover:text-white') + ' font-medium px-3 py-2 rounded-lg shadow'">
            ...
            <JustificationsApprenantTable :justifications="props.justifications" class="mb-6"
...
import JustificationsApprenantTable from '../Components/ApprenantJustification/JustificationsApprenantTable.vue';
import AddModal from '../Components/ApprenantJustification/AddJustificationModal.vue';
import UpdateModal from '../Components/ApprenantJustification/updateJustificationModal.vue';
...
function Filter() {
    router.visit(route('Justificatifs.apprenant',formFilter));
}
</script>
